...
def prepare(output):
	...
	os.chdir(output)
	os.system("pwd")
	print("Download snp masked reference genome for hisat2")
	os.system("wget https://genome-idx.s3.amazonaws.com/hisat/grch37_snp.tar.gz")
	os.system("tar xvzf grch37_snp.tar.gz &")
	#os.system("rm xvzf grch37_snp.tar.gz")
	print("Download reference RNA editing sites from REDIportal")
	...
	print("Download and index reference sequence file for hg19")
